...
public class OrderMapperTests {
	...
	public void getOrderInfoTest() {
		 ...
		 OrderItemDTO orderInfo = mapper.getOrderInfo(21);
	...
	public void enrollOrderTest() {
		...
		order1.setBookPrice(20000);
		order1.setBookDiscount(0.2);
	...
	public void enrollOrderItemTest() {
		...
		oid.setOrderId("2023_test3");
		oid.setBookId(21);
		oid.setBookCount(1);
		oid.setBookPrice(20000);
