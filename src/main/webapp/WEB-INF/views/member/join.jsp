	...
	<div class="wrap">
			...
			<div class="mail_wrap">
				...
				<div class="mail_check_wrap">
					...
					<span id="mail_check_input_box_warn"></span> <!-- 인증번호 일치여부 확인 -->
				</div>
			</div>
...
//아이디 중복검사
$('.id_input').on("propertychange change keyup paste input", function(){ // property~input은 모든 텍스트의 변경에 반응하는 문법
...
$(".mail_check_button").click(function(){
	...
	$.ajax({
		...
		success:function(data){
			...
			checkBox.attr("disabled",false); // 인증성공시 인증번호 입력이 가능하도록 변경
			boxWrap.attr("id","mail_check_input_box_true");
			code = data; // 받은 인증번호를 code라는 변수에 저장
		}
	});	
});
...
function mailFormCheck(email){
	...
	return form.test(email); // email이 form에 저장된 정규표현식에 부합할 경우 true, 그렇지 않은 경우 false를 반환
}
